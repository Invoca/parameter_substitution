...
require_relative '../../../../lib/parameter_substitution/formatters/date_us_normal'

describe ParameterSubstitution::Formatters::DateUsNormal do
  context "Date US Normal formatter test" do
    before do
      @format_class = ParameterSubstitution::Formatters::DateUsNormal
    end

    it "have a key" do
      expect(@format_class.key).to eq("date_us_normal")
    end
