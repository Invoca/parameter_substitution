...
require_relative '../../../../lib/parameter_substitution/formatters/date_time_us_seconds'

describe ParameterSubstitution::Formatters::DateTimeUsSeconds do
  context "Date Time US Seconds formatter test" do
    before do
      @format_class = ParameterSubstitution::Formatters::DateTimeUsSeconds
    end

    it "have a key" do
      expect(@format_class.key).to eq("date_time_us_seconds")
    end
