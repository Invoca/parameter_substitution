  ...
  context "Parser" do
    ...
    context "full expression testing" do
      ...
      it "handle a complicated case with multiple method_calls and arguments" do
        assert_parse_output(
          "preamble<substitution_param.method_call1(\"arg1\", 123).method_call2>postamble",
          expression: [
            { text: "preamble" },
      ...
      it "handle a method_call with a substitution param as an argument" do
        assert_parse_output(
          "preamble<substitution_param.method_call(<substitution_arg>)>postamble",
          expression: [
            { text: "preamble" },
            { parameter_name: "substitution_param",
              method_calls:   [
      ...
      it "handle a method_call with a substitution param and method call as an argument" do
        assert_parse_output(
          "preamble<substitution_param.method_call1(<substitution_arg.method_call2>)>postamble",
          expression: [
            { text: "preamble" },
            { parameter_name: "substitution_param",
              method_calls:   [
      ...
      it "handle a method_call with a substitution param and method call and argument as an argument" do
        assert_parse_output(
          "preamble<substitution_param.method_call1(<substitution_arg.method_call2(\"string_arg\")>)>postamble",
          expression: [
            { text: "preamble" },
            { parameter_name: "substitution_param",
              method_calls:   [
